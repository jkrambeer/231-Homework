 ...
 * 9/19/2015
 ****/
public class UnsortedDirectoryTester
{
	public static void main(String[] args)
	{
		UnsortedDirectory test;
		test = new UnsortedDirectory();
		...
		test.addStudent("lohn Smith","222-222-222");//unique names take into accout capitalization
